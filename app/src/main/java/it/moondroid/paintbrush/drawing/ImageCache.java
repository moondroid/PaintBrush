...
/**
 * Created by marco.granatiero on 04/09/2014.
 */
...
import it.moondroid.paintbrush.BuildConfig;
...
public class ImageCache {
    ...
    public void addBitmapToCache(String data, Bitmap bitmap) {
        ...
        if (mMemoryCache != null && mMemoryCache.get(data) == null) {
            ...
            Log.d(TAG, "addBitmapToCache: mMemoryCache");
        }
                ...
                try {
                    ...
                    if (snapshot == null) {
                        ...
                        if (editor != null) {
                            ...
                            editor.commit();
                            out.close();
                            Log.d(TAG, "addBitmapToCache: mDiskLruCache");
                        }
                    } else {
